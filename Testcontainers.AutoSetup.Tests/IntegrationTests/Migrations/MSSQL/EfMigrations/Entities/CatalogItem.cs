...
public class MSSQLCatalogItem : MSSQLBaseEntity, IMSSQLAggregateRoot
{
    ...
    public MSSQLCatalogType? CatalogType { get; private set; }
    public int CatalogBrandId { get; private set; }
    public MSSQLCatalogBrand? CatalogBrand { get; private set; }

    public MSSQLCatalogItem(int catalogTypeId,
        int catalogBrandId,
        string description,
        string name,
        decimal price,
