...
public static class MSSQLModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<MSSQLCatalogBrand>().HasData(GetPreconfiguredCatalogBrands());
        modelBuilder.Entity<MSSQLCatalogType>().HasData(GetPreconfiguredCatalogTypes());
        modelBuilder.Entity<MSSQLCatalogItem>().HasData(GetPreconfiguredItems());
    }

    private static IEnumerable<MSSQLCatalogBrand> GetPreconfiguredCatalogBrands()
    {
        return new List<MSSQLCatalogBrand>
        {
            new("Azure") { Id = 1 },
            new(".NET") { Id = 2 },
    ...
    private static IEnumerable<MSSQLCatalogType> GetPreconfiguredCatalogTypes()
    {
        return new List<MSSQLCatalogType>
        {
            new("Mug") { Id = 1 },
            new("T-Shirt") { Id = 2 },
            new("Sheet") { Id = 3 },
    ...
    private static IEnumerable<MSSQLCatalogItem> GetPreconfiguredItems()
    {
        return new List<MSSQLCatalogItem>
        {
