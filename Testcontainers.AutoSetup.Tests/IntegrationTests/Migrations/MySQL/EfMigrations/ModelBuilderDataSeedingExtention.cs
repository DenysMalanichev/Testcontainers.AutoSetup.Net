...
public static class MySQLModelBuilderExtensions
{
    ...
    {
        modelBuilder.Entity<MySQLCatalogBrand>().HasData(GetPreconfiguredCatalogBrands());
        modelBuilder.Entity<MySQLCatalogType>().HasData(GetPreconfiguredCatalogTypes());
        modelBuilder.Entity<MySQLCatalogItem>().HasData(GetPreconfiguredItems());
    }

    private static IEnumerable<MySQLCatalogBrand> GetPreconfiguredCatalogBrands()
    {
        return new List<MySQLCatalogBrand>
        {
            new("Azure") { Id = 1 },
            new(".NET") { Id = 2 },
    ...
    private static IEnumerable<MySQLCatalogType> GetPreconfiguredCatalogTypes()
    {
        return new List<MySQLCatalogType>
        {
            new("Mug") { Id = 1 },
            new("T-Shirt") { Id = 2 },
            new("Sheet") { Id = 3 },
    ...
    private static IEnumerable<MySQLCatalogItem> GetPreconfiguredItems()
    {
        return new List<MySQLCatalogItem>
        {
