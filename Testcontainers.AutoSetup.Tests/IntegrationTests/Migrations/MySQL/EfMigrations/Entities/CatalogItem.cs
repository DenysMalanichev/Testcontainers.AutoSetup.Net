...
public class MySQLCatalogItem : MySQLBaseEntity, IMySQLAggregateRoot
{
    ...
    public MySQLCatalogType? CatalogType { get; private set; }
    public int CatalogBrandId { get; private set; }
    public MySQLCatalogBrand? CatalogBrand { get; private set; }

    public MySQLCatalogItem(int catalogTypeId,
        int catalogBrandId,
        string description,
        string name,
        decimal price,
